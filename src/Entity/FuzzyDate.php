...
class FuzzyDate
{
    ...
    public function setByDateString($input_string = null){
        $length = strlen($input_string);

        if($input_string === 'undated'){
            $this->date_string = "undated";
            $this->full_date = null;
            $this->accuracy = null;
        }
        else if($length < 2||is_null($input_string)){
            $this->date_string = "undated";
            $this->full_date = null;
            $this->accuracy = null;
            echo "The fuzzy date is empty";
        }
        else if($length == 4){
            ...
            else if (strcmp($input_string,"undated")===0){
                $this->date_string = "undated";
                $formated_date = null;
            }
            else {
    ...
    public function setByDateAccuracy($date = null, $accuracy = null)
    {
        if($date !== null && $accuracy !== null) {
            ...
            if ($accuracy == 0) {
                ...
                if (strcmp($formated_date, "9999") === 0) $this->date_string = "undated";
                else if (strcmp($formated_date, "0000") === 0) $this->date_string = "undated";
